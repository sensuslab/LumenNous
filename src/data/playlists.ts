...
const raw: Playlist[] = [
  ...
  },
  {
    ...
    title: "Chakra Contemplation",
    description:
      "Listening for symbolic centre-by-centre reflection: singing bowls and frequency-labelled ambient (432 Hz and 528 Hz). EVIDENCE NOTE: bowls carry an experiential-claim label; 432/528 Hz items are labelled no-established-clinical-evidence — enjoy them as music and symbolism, never as treatment.",
    intendedUse: "Symbolic chakra contemplation",
    duration: 90,
    itemIds: ["aud-singing-bowls", "aud-432-meditation", "aud-solfeggio-528"],
    externalLinks: [],
    coverImage: "",
    editorialStatus: "draft",
  },
  {
    ...
    description:
      "For the edge of sleep: the eight-hour 'Sleep' album, binaural-labelled tracks and slow radio. EVIDENCE NOTE: binaural items carry an experiential-claim label (listener reports; mixed preliminary research) — keep volumes low and let sleep, not the track, do the work.",
    intendedUse: "Falling and staying asleep",
    duration: 240,
    itemIds: ["aud-max-richter-sleep-apple", "aud-binaural-sleep", "aud-bbc-slow-radio"],
    externalLinks: [],
    coverImage: "",
    editorialStatus: "draft",
  },
